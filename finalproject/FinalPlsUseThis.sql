...
CREATE TABLE `account` (
  ...
  `user_username` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci DEFAULT NULL,
  `user_password` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `account` VALUES (16,'it62070035','$2b$05$7XCV31qa.NPNjsEmXi4jhejluHZTMQXmucVmr1SMnPup9J0eCMlem',16),(17,'KKKKK','$2b$05$xWi.86RqgD.8xxoIrGs2X.ILdW.Mus/x30P96h5BMoBzvwfhqD5Qm',17),(18,'QQQQQ','$2b$05$qH8NP4jKJXukytCvcRK1OOCa7eiJ5qOcaBfe.VQJQ50Nm7PxbGOoW',18),(19,'EEEEE','$2b$05$JT13l0UllFTq3u0E5UCj6uVbNJIvo0NKgIYSq3Ej/PVhLosE/bIUu',19),(20,'RRRRR','$2b$05$jgaXt82Eubafd8GjU1kg4Ot.Xp8tU71sujAKx8Rq2Bj.ffUiLwUqy',20),(21,'TTTTT','$2b$05$8v2y2hRRK5AoHQmqppzGleboRrD/5ysbdtWBK2inZGRdiQ2E0sGyi',21),(22,'YYYYY','$2b$05$q6bdj13FR9V2qLTwU4eC.eDf4P44OkTfA2ZT5Qn.QsHLRjOOLauKG',22),(23,'UUUUU','$2b$05$aj2Bmt8KzDHG1NoNHUxRGuv0sX.wxZQMqigbEZOmhDQOHkDtrmTNW',23),(24,'IIIII','$2b$05$jTeYMSCV1GpZanIQ8TH/TOEFoVXCciSP38vV5nVDbuL./qno4e7YC',24),(25,'OOOOO','$2b$05$4beuGdd0hC7N/XqXYdnmi.EuMFuZ0DqVZ9oI1Mqb0H88Aybs0tOni',25),(26,'phawit-s','$2b$05$mYApR8FK9yGWrdZc0QhFROHPip4ztj5bqo6kaJFboXc9YL8/IJXc.',26),(27,'phawit1715','$2b$05$3.AvW20EquIKfftICOVm.eSSnzTxCuExsuqXGdz98PnWVZ6GgJFA6',27),(28,'phawit1212','$2b$05$tQT0Y1OSU1woYpio2SWQyO6lCasUZjMWWvi3TJ099EoIg5E03RT1S',28),(29,'phawit1111','$2b$05$ge9nOZ5yTrFtt0L9AFzsHuqUzIZKbaOe9Igt5zSxTmkzPu27PRM8m',29),(30,'phawit2222','$2b$05$ra5eO3Ql13teLe9rX9YW0upllTxSOEY5/c6xAvYOMm6F7Wsmq7Ksm',30),(31,'phawit1234','$2b$05$WfQgrY6xZJ91sBCVEey/nezZoql8QszEoO0h7iMoe3J4OkawCYSpy',31);
...
INSERT INTO `order` VALUES (1,'2021-05-07','2021-05-07',650.00,1,17),(2,'2021-05-07','2021-05-07',1600.00,1,23),(3,'2022-05-17','2022-05-04',1600.00,2,30);
...
INSERT INTO `order_item` VALUES (1,1,650,650,1,8),(2,1,1600,1600,2,20),(3,2,800,1600,3,6);
...
CREATE TABLE `owner` (
  ...
  `owner_username` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci DEFAULT NULL,
  `owner_password` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `owner` VALUES (1,'Fluke','FFDknk99'),(2,'it62070035','$2b$05$7XCV31qa.NPNjsEmXi4jhejluHZTMQXmucVmr1SMnPup9J0eCMlem'),(3,'KKKKK','$2b$05$CkbuNLcoohDylEKcSucFiupo/fWS9c3QtUst0mlYWigNnKJaodoIq'),(4,'QQQQQ','$2b$05$qH8NP4jKJXukytCvcRK1OOCa7eiJ5qOcaBfe.VQJQ50Nm7PxbGOoW'),(5,'EEEEE','$2b$05$JT13l0UllFTq3u0E5UCj6uVbNJIvo0NKgIYSq3Ej/PVhLosE/bIUu'),(6,'TTTTT','$2b$05$8v2y2hRRK5AoHQmqppzGleboRrD/5ysbdtWBK2inZGRdiQ2E0sGyi'),(7,'OOOOO','$2b$05$4beuGdd0hC7N/XqXYdnmi.EuMFuZ0DqVZ9oI1Mqb0H88Aybs0tOni'),(8,'phawit1212','$2b$05$fOS5SuiZpV4bCDoLXtUlruQmTd8jO7q98rDSE2dI4SXMR5sLF3aeu'),(9,'phawit2222','$2b$05$ra5eO3Ql13teLe9rX9YW0upllTxSOEY5/c6xAvYOMm6F7Wsmq7Ksm');
...
CREATE TABLE `product` (
  ...
  `product_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci DEFAULT NULL,
  `category` enum('camera','film','radio','sensor','speaker') CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `product_type` (
  ...
  `type_name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci DEFAULT NULL,
  `other_spec` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci DEFAULT NULL,
  `price` float DEFAULT NULL,
  `amount_product` int DEFAULT NULL,
  `brand` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci DEFAULT NULL,
  `product_product_id` int NOT NULL,
...
INSERT INTO `tokens` VALUES (3,'ru1-U/34KPfy#1p#FD6k7eq3MKYrUg29nLjAWBudCfTuk@7j/UuacgcPjRzvJ*p9/zmfp/gcyYjF/*YabSK4Fp!2@UWRE=zQ6aUl',17),(4,'Dw/6bPd4JP5uK9n$nt0I-M5Ux^rWsEnxMb4LqqlW*Jz@WwPgYC7*/FTY7UDmXSX-SR!HTKslH1bVRSU*i9DK7tXXI1w6g&KM79-A',18),(5,'=h^/pd*YM7!KumS7FjtXBmkNF8@zPovtc$fCJHbs*z9ui/CjdHWpVO-sloyODy9YGGH#Bgx-L#X-Tt$QAja^rsj&Jbi6apD-Ttu6',19),(6,'LWzUjc3inT$voVB-WUZ@XMN/A$u^i-waLyiYN@t=Z1U#YXI&ATy64#0BSKmER!8sRlFzysLsX&qlWPYhhoRI0THsYjSoRt4FOiTo',20),(7,'hEmTW4Dhc^dp4zSuogEVwCO/d8Xjn^jvc4kdyAf@^^K6W&AG$K^h4juIkWKEnBQI7KIyBAH6/R$0@4HK15*y65JEXjO13alXjDR*',23),(8,'ny#HBG#PDPd1*3rslwBbp$tpl&cVg@4W0HswPpkYy1=8@U5$ZASW4ZGyjfkGyH7OUBtrVpmzVPO1y$!uQv3NU5jH#/&T&NYtdl/l',26),(9,'EFR!Cru0SvJkiIk9iw5#rTVxAeUh3=&&zfz4/*hU9WW!p2SeGIg8hQqsyQy&WQL6ju-2o!ORAY^yuW&zYu7gZ@*ud72mvMlEyILU',27),(10,'vC9nazjU^IePTH15Z!fGz25-SqLs^zsCxHsrSX3Aa41rtpNGLRqBoyM7#H$4rOBY3qeIt!!UMpBKXaoc*aaz6^mKdOvzv^O-b2DY',28),(11,'4A1swFoQwyj!7oimP6J^&R@mT36j$aKIRj8Xe$o@CLoLGIYay$5/yG9=uwQ@MRp^UAd$M#chDdE9v!OFRIE4w&SNiCdp1Ajejb@Q',29),(12,'llJw2JkZulxuhXum*LrcYiB8*JjT&Qae#Pk1@r2Way/DD4Ssd$NqfB2fI2mN@FVNJFi28q&6=uD8oFh^AuZ=QFGGPc0ZOn6BWW$5',30),(13,'DJz-$btwRvlzn*D-kk4le4QYoz4BsymBffgRH7cemjk1agrRi1Zyv#&LZ6Og@t85HfdEy=Ei9F7Y5!dNlTMpyQBU@tKPpK8gi!@d',31);
...
CREATE TABLE `user` (
  ...
  `user_status` enum('customer','owner') CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci DEFAULT 'customer',
  `user_fname` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci DEFAULT NULL,
  `user_lname` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci DEFAULT NULL,
  `user_phone` char(10) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci DEFAULT NULL,
  `user_image` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`user_id`),
...
INSERT INTO `user` VALUES (16,'owner','Jirayuth','Dokkathin','0905560100','1.jpg'),(17,'owner','Kaimook','CMCAFEEEEEEE','0222222222','2.jpg'),(18,'owner','Qury','Sam','0999999999','3.jpg'),(19,'owner','Earn','lanee','0666666666','4.jpg'),(20,'customer','Rally','CS','0777777777','5.jpg'),(21,'owner','Tinee','serson','0101111111','6.jpg'),(22,'customer','Yoran','hima','0777777777','7.jpg'),(23,'customer','Uri','snale','0666666666','8.jpg'),(24,'customer','Iron','smit','0666666666','9.jpg'),(25,'owner','Ole','oreen','0622222222','10.jpg'),(26,'customer','phawit','sapthaweekarn','0909934126','11.jpg'),(27,'customer','Phawit','sapthaweekarn','0123231131','12.jpg'),(28,'owner','phawit','2','0324432434','b74641d9c605c273ee8a5ca4c10c7e23.jpg'),(29,'customer','Phaawi2','asdasdsaad','0213123123','0ae1c8061f8310316da6dd54d14443e6 (1).jpg'),(30,'owner','Phwait','sadasd','0213123123','01phawit.jpg'),(31,'customer','phawit','sapthaweekarn','0983423423','16.jpg');
...
-- Dump completed on 2022-05-04 15:59:22
